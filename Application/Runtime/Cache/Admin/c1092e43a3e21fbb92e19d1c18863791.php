        ...
        <div class="container-fluid">
            <div class="row-fluid">
                    <table  class="table">
                         ...
                         <tbody>
                         	<form class="form-inline" method="post" action="/report/index.php/Admin/Percent/list_part">
                            <tr>
                                <td>
                                    <input  name="student_name" placeholder="姓名" id="appendedInputButton" type="text">
                                </td>
                                <td>
                                     <select class="" name="task_percent_down" >
                                ...
                                <td>
                                    <select class="" name="task_percent_up" >
                                     	<option value="100">100%</option>
                                        <option value="90">90%</option>
                                        <option value="80">80%</option>
                                        <option value="70">70%</option>
                                ...
                                <td>
                                      <input type="text" value="0000-00-00" value="" class="laydate-icon" id="start"  name="time_time1">
                                </td>  
                                <td >
                    ...
                    <table class="table">
                      ...
                      <tbody>
                      		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                    	<a href="/report/index.php/Admin/Percent/schedule/task_id/<?php echo ($vo["task_id"]); ?>">详情</a>
                                    </td>
                                   <!-- <td>
                                    	<a href="/report/index.php/Admin/Percent/message/student_id/<?php echo ($vo["student_id"]); ?>">消息</a>
                                    </tr>-->
