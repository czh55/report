            ...
            <div class="row-fluid">
                ...
                <div class="well">
                    <table class="table">
                      ...
                      <tbody>
                      		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><form class="form-inline" method="post" action="/report/index.php/Home/Verify/do_percent100/task_id/<?php echo ($vo["id"]); ?>">
                            	<tr>
                                    ...
                                    <td>
                                    	 <input  name="task_grade" placeholder="得分" id="appendedInputButton" type="text">
                                    </td>
                                    <td>
                                    	 <input  name="checkbox" value="1" id="appendedInputButton" type="checkbox">
                                    </td>
                                    <td>
