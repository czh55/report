                ...
                <div class="well">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane active in" id="home">
                            <form id="tab" method="post" action="/report/index.php/Home/Excel/all">
                            	
                                <label>请选择年份</label>
                                 <select name="time" id="DropDownTimezone" class="input-xlarge">
                                		<?php if(is_array($date)): foreach($date as $key=>$vo): ?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?>年</option><?php endforeach; endif; ?>                                     
                         		 </select> 
                            	 <input type="text" value="dif" class="input-xlarge hidden" name="dif"><!--区分两种情况的-->
