...
<html lang="en">
  ...
  <!--<![endif]-->
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="btn-toolbar">
                    <a href="/report/index.php/Home/Form/add_student/task_id/<?php echo ($task_id); ?>"><button class="btn btn-primary"><i class="icon-plus"></i> New User</button></a>
    ...
    <script type="text/javascript">
        ...
        function model(id)
        {
        		$("#delete").attr('href','/report/index.php/Home/Form/delete_student/student_id/'+id+"/task_id/<?php echo ($task_id); ?>");
        }
    </script>
