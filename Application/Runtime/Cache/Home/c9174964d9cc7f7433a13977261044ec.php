                ...
                <div class="well">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane active in" id="home">
                            <form id="tab" method="post" action="/report/index.php/Home/Task/edit_task">
                            	
                                <label>任务类型</label>
                                <input type="text" value="<?php echo ($name); ?>" class="input-xlarge" name="type">
                                <label>任务计划截止时间</label>
                                <input  class="laydate-icon input-xlarge" id="start"  type="text" value="<?php echo ($time_plan); ?>"  name="time_plan">
                                <label>任务内容</label>
                                <input type="text" value="<?php echo ($content); ?>" class="input-xlarge" name="content">
                                <label>任务说明</label>
                                <input type="text" value="<?php echo ($instruction); ?>" class="input-xlarge" name="instruction">
