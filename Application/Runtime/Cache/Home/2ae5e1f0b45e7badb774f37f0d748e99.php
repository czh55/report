  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li ><a href="/report/index.php/Home/Task/year">本年任务</a></li>
            <li ><a href="/report/index.php/Home/Task/month">本月任务</a></li>        
            
        </ul>

        <a href="#accounts-menu " class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>分组处理</a>
        <ul id="accounts-menu" class="nav nav-list collapse in">
            <li ><a href="/report/index.php/Home/Form/index">小组任务</a></li>
                ...
                <div class="well">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane active in" id="home">
                            <form id="tab" method="post" action="/report/index.php/Home/Form/save_student">
                                <label>学生姓名</label>
                                <select name="student_id" id="DropDownTimezone" class="input-xlarge">
                                		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>                                     
                         		 </select> 
                              	 <input type="text" value="<?php echo ($task_id); ?>" class="input-xlarge hidden" name="task_id" >
