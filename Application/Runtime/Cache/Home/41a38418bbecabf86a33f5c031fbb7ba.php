                ...
                <div class="well">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane active in" id="home">
                            <form id="tab">
                                <label>任务类型</label>
                                <input type="text" value="<?php echo ($name); ?>" class="input-xlarge">
                                <label>任务内容</label>
                                <input type="text" value="<?php echo ($content); ?>" class="input-xlarge">
                                <label>任务说明</label>
                                <input type="text" value="<?php echo ($instruction); ?>" class="input-xlarge">
                            </form>
                        </div>
