        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="btn-toolbar">
                    <a href="/report/index.php/Home/Task/add_schedule/task_id/<?php echo ($task_id); ?>"><button class="btn btn-primary"><i class="icon-plus"></i> New User</button></a>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                      		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                        <a href="/report/index.php/Home/Task/content_schedule/task_id/<?php echo ($task_id); ?>/schedule_id/<?php echo ($vo["id"]); ?>"><i class="icon-pencil"></i></a>
                                    </td>
